...
var TableLookup = map[string]Table{
	...
	`0003`: {ID: `0003`, Name: `Event type`, Row: []Row{
		...
		{ID: `E30`, Description: `Submit Health Document related to Authorization Request`, Comment: `reserved for future/not yet defined`},
		{ID: `E31`, Description: `Cancel Health Document related to Authorization Request`, Comment: `reserved for future/not yet defined`},
		...
		{ID: `M03`, Description: `MFN/MFK - Master file - test/observation (f or backward compatibility only )`},
	...
	`0061`: {ID: `0061`, Name: `Check digit scheme`, Row: []Row{
		{ID: `BCV`, Description: `Bank Card Validation Number`, Comment: `A non-embossed number included on bank cards and used to validate authenticity of the card and the person presenting the card`},
	...
	`0076`: {ID: `0076`, Name: `Message type`, Row: []Row{
		...
		{ID: `EHC`, Description: `Health Care Invoice`, Comment: `16`},
		...
		{ID: `OMS`, Description: `Stock requisition order message`, Comment: `4`},
		{ID: `OPL`, Description: `Population/Location-Based Laboratory Order Message`, Comment: `4`},
		{ID: `OPR`, Description: `Population/Location-Based Laboratory Order Acknowledgment Message`, Comment: `4`},
		{ID: `OPU`, Description: `Unsolicited Population/Location-Based Laboratory Observation Message`, Comment: `7`},
		...
		{ID: `SCN`, Description: `Notification of Anti-Microbial Device Cycle Data`, Comment: `17`},
		{ID: `SDN`, Description: `Notification of Anti-Microbial Device Data`, Comment: `17`},
		{ID: `SDR`, Description: `Sterilization anti-microbial device data request`, Comment: `17`},
		{ID: `SIU`, Description: `Schedule information unsolicited`, Comment: `10`},
		{ID: `SLN`, Description: `Notification of New Sterilization Lot`, Comment: `17`},
		{ID: `SLR`, Description: `Sterilization lot request`, Comment: `17`},
		{ID: `SMD`, Description: `Sterilization anti-microbial device cycle data request`, Comment: `17`},
		...
		{ID: `STC`, Description: `Notification of Sterilization Configuration`, Comment: `17`},
		{ID: `STI`, Description: `Sterilization item request`, Comment: `17`},
	...
	`0085`: {ID: `0085`, Name: `Observation result status codes interpretation`, Row: []Row{
		...
		{ID: `S`, Description: `Partial results. Deprecated. Retained only for backward compatibility as of V2.6.`, Comment: `Deprecated.`},
	...
	`0104`: {ID: `0104`, Name: `Version ID`, Row: []Row{
		...
		{ID: `2.5.1`, Description: `Release 1.5.1`, Comment: `January 2007`},
		{ID: `2.6`, Description: `Release 2.6`, Comment: `July 2007`}}},
	...
	`0119`: {ID: `0119`, Name: `Order control codes`, Row: []Row{
		{ID: `AF`, Description: `Order/service refill request approval`, Comment: `Placer Applications. AF is a response to RF where the placer authorizing a refill or quantity of refills.`},
		{ID: `CA`, Description: `Cancel order/service request`, Comment: `Placer Applications. A cancellation is a request by the placer for the filler not to do a previously ordered service. Confirmation of the cancellation request is provided by the filler, e.g., a message with an ORC-1-order control value of CR. Typical responses include, but are not limited to, CR - Cancelled as requested, UC - Unable to Cancel.`},
		{ID: `CH`, Description: `Child order/service`, Comment: `Placer or Filler Applications. Used in conjunction with the PA - Parent order control code. Refer to PA order control code for discussion.`},
		...
		{ID: `CR`, Description: `Canceled as requested`, Comment: `Filler Applications. A response by the filler application that a request to cancel (CA by the placer application) was performed successfully.`},
		{ID: `DC`, Description: `Discontinue order/service request`, Comment: `Placer Applications. A request by the placer application for the filler application to discontinue a previously requested service. The differentiation between discontinue and cancel is that discontinue effects the order/service and all future occurrences, cancel refers to just the present action. Typical responses include, but are not limited to, CR - Cancelled as requested, UC - Unable to Cancel.`},
		{ID: `DE`, Description: `Data errors`, Comment: `Placer or Filler Applications.`},
		...
		{ID: `UC`, Description: `Unable to cancel`, Comment: `Filler Applications. An unable-to-cancel code is used when the ordered service is at a point that it cannot be canceled by the filler or when local rules prevent cancellation by the filler. The use of this code is dependent on the value of ORC-6-response flag.`},
		{ID: `UD`, Description: `Unable to discontinue`, Comment: `Filler Applications.`},
		{ID: `UF`, Description: `Unable to refill`, Comment: `Filler Applications. Negative response to RF Refill order/service request, indicating that the receiving application was not able to complete the refill request.`},
		{ID: `UH`, Description: `Unable to put on hold`, Comment: `Filler Applications.`},
		{ID: `UM`, Description: `Unable to replace`, Comment: `Filler Applications.`},
		{ID: `UN`, Description: `Unlink order/service from patient care problem or goal`, Comment: `Placer or Filler Applications. Refer to Chapter 12 Patient Care for complete discussion.`},
		{ID: `UR`, Description: `Unable to release`, Comment: `Filler Applications.`},
		{ID: `UX`, Description: `Unable to change`, Comment: `Filler Applications.`},
		{ID: `XO`, Description: `Change order/service request`, Comment: `Placer Applications.`},
		{ID: `XR`, Description: `Changed as requested`, Comment: `Filler Applications.`},
		{ID: `XX`, Description: `Order/service changed, unsol.`, Comment: `Filler Applications.`}}},
	...
	`0190`: {ID: `0190`, Name: `Address type`, Row: []Row{
		{ID: `B`, Description: `Firm/Business`, Comment: `Refers to an address specific to an organization, such as an insurance company or employer, versus an individual’s work location or place of employment. It would be specific to a firm or organization that has some sort of business relationship with the subject`},
		{ID: `BA`, Description: `Bad address`, Comment: `Retained for backward compatibility only as of v2.6. Refer to XAD.17`},
		{ID: `BDL`, Description: `Birth delivery location (address where birth occurred)`, Comment: `Refers to the address where birth occurred.`},
		{ID: `BI`, Description: `Billing Address`, Comment: `May also be used for the validation/authorization of credit cards`},
		{ID: `BR`, Description: `Residence at birth (home address at time of birth)`, Comment: `Refers to the home address at time of birth.`},
		{ID: `C`, Description: `Current Or Temporary`, Comment: `Retained for backward compatibility only as of v2.6. Refer to XAD.16`},
		{ID: `F`, Description: `Country Of Origin`},
		{ID: `H`, Description: `Home`, Comment: `Refers to a residence or domicile, literally the place where the subject resides the majority of the time. Generally speaking most people will have a home address and it will represent their primary address. Home address is mutually exclusive of permanent address.`},
		{ID: `L`, Description: `Legal Address`, Comment: `Refers to a special case address specific to the status of a subject or legal action involving the subject. For example, prisoners being treated at a healthcare facility may have home addresses, but their status mandates an address specific to their place of incarceration. Statutes may require the health information specific to a ward of the state be sent to a legal guardian, the courts, or a state or municipal agency regardless of the ward’s physical location. In cases involving civil or criminal proceedings, a record may be flagged such that all correspondence is sent to any variety of legal entities.`},
		{ID: `M`, Description: `Mailing`, Comment: `Retained for backward compatibility only as of v2.6. Refer to XAD.18`},
		{ID: `N`, Description: `Birth (nee) (birth address, not otherwise specified)`, Comment: `Refers to the birth address, not otherwise specified`},
		{ID: `O`, Description: `Office/Business`, Comment: `Refers to a work address specific to the subject.`},
		...
		{ID: `RH`, Description: `Registry home. Refers to the information system, typically managed by a public health agency, that stores patient information such as immunization histories or cancer data, regardless of where the patient obtains services.`, Comment: `Refers to the information system, typically managed by a public health agency that stores patient information such as immunization histories or cancer data, regardless of where the patient obtains services`},
		{ID: `S`, Description: `Service Location`, Comment: `Refers to the location in which service is rendered. This would be used if reimbursement is based on the location of the service (to take into account the cost of those services).`},
	...
	`0201`: {ID: `0201`, Name: `Telecommunication use code`, Row: []Row{
		...
		{ID: `BPN`, Description: `Beeper Number`, Comment: `Retained for backward compatibility as of v2.6`},
		{ID: `EMR`, Description: `Emergency Number`},
		{ID: `NET`, Description: `Network (email) Address`, Comment: `Retained for backward compatibility as of v2.6`},
		{ID: `ORN`, Description: `Other Residence Number`},
		{ID: `PRN`, Description: `Primary Residence Number`},
		{ID: `PRS`, Description: `Personal`, Comment: `Not tied to a location or role`},
	...
	`0203`: {ID: `0203`, Name: `Identifier type`, Row: []Row{
		...
		{ID: `AMA`, Description: `American Medical Association Number`, Comment: `A physician identifier assigned by the AMA.`},
		...
		{ID: `BCT`, Description: `Birth Certificate`, Comment: `A number associated with a document identifying the event of a person’s birth.`},
		{ID: `BR`, Description: `Birth registry number`, Comment: `An identifier unique within the Assigning Authority that is the official legal record of a person's birth.`},
		...
		{ID: `CONM`, Description: `Change of Name Document`, Comment: `A number associated with a document identifying a person’s legal change of name.`},
		{ID: `CY`, Description: `County number`},
		{ID: `CZ`, Description: `Citizenship Card`, Comment: `A number assigned by a person’s country of residence to identify a person’s citizenship.`},
		...
		{ID: `DP`, Description: `Diplomatic Passport`, Comment: `A number assigned to a diplomatic passport.`},
		...
		{ID: `ESN`, Description: `Staff Enterprise Number`, Comment: `An identifier that is unique to a staff member within an enterprise (as identified by the Assigning Authority).`},
		...
		{ID: `MCT`, Description: `Marriage Certificate`, Comment: `A number associated with a document identifying the event of a person’s marriage.`},
		...
		{ID: `NCT`, Description: `Naturalization Certificate`, Comment: `A number associated with a document identifying a person’s retention of citizenship in a particular country.`},
		...
		{ID: `PC`, Description: `Parole Card`, Comment: `A number identifying a person on parole.`},
		...
		{ID: `PPIN`, Description: `Medicare/CMS Performing Provider Identification Number`, Comment: `Class: Insurance An Identifier for a provider at a location in the CMS/Medicare program. This identifier type is only unique within the context of a location. The location is not integral to the identifier, it must be derived from the message context/content (e.g., this identifier associated to a location by association in a message or a message segment.)`},
		...
		{ID: `RR`, Description: `Railroad Retirement number`, Comment: `An identifier for an individual enrolled with the Railroad Retirement Administration. Analogous to, but distinct from, a Social Security Number`},
		{ID: `RRI`, Description: `Regional registry ID`},
		{ID: `RRP`, Description: `Railroad Retirement Provider`, Comment: `Class: Insurance An identifier for a provider register within the CMS/Railroad Retirement Administration/Medicare program (a subprogram of the CMS/Medicare)`},
		...
		{ID: `SP`, Description: `Study Permit`, Comment: `A number associated with a permit identifying a person who is a resident of a jurisdiction for the purpose of education.`},
		...
		{ID: `TPR`, Description: `Temporary Permanent Resident (Canada)`, Comment: `A number associated with a document identifying a person’s temporary permanent resident status.`},
		{ID: `U`, Description: `Unspecified identifier`},
		{ID: `UPIN`, Description: `Medicare/CMS (formerly HCFA)’s Universal Physician Identification numbers`, Comment: `Class: Insurance An identifier for a provider within the CMS/Medicare program. A globally unique identifier for the provider in the Medicare program.`},
		{ID: `VN`, Description: `Visit number`},
		{ID: `VP`, Description: `Visitor Permit`, Comment: `A number associated with a document identifying a person as a visitor of a jurisdiction or country.`},
		...
		{ID: `WP`, Description: `Work Permit`, Comment: `A number associated with a permit for a person who is granted permission to work in a country for a specified time period.`},
	...
	`0211`: {ID: `0211`, Name: `Alternate character sets`, Row: []Row{
		...
		{ID: `UNICODE`, Description: `The world wide character standard from ISO/IEC 10646-1-1993[5]`, Comment: `Deprecated. Retained for backward compatibility only as v 2.5. Replaced by specific Unicode encoding codes.`},
	...
	`0227`: {ID: `0227`, Name: `Manufacturers of Vaccines`, Row: []Row{
		...
		{ID: `AR`, Description: `Armour`, Comment: `[Inactive--use AVB]`},
		{ID: `AVB`, Description: `Aventis Behring L.L.C.`, Comment: `(formerly Centeon L.L.C.; includes Armour Pharmaceutical Company) [Inactive--use ZLB]CDC Changes made on: Feb. 28, 2006`},
		{ID: `AVI`, Description: `Aviron`},
		{ID: `BA`, Description: `Baxter Healthcare Corporation`, Comment: `[Inactive--use BAH]`},
		{ID: `BAH`, Description: `Baxter Healthcare Corporation`, Comment: `(includes Hyland Immuno, Immuno International AG, and North American Vaccine, Inc.)`},
		...
		{ID: `CHI`, Description: `Chiron Corporation`, Comment: `[Inactive--use NOV] includes PowderJect Pharmaceuticals, Celltech Medeva Vaccines and Evans Medical Limited CDC Changes made on: July 14, 2006`},
		{ID: `CMP`, Description: `Celltech Medeva Pharmaceuticals`, Comment: `[Inactive--use NOV]CDC Changes made on: July 14, 2006`},
		{ID: `CNJ`, Description: `Cangene Corporation`, Comment: `CDC Changes made on: Feb. 28, 2006`},
		{ID: `CON`, Description: `Connaught`, Comment: `[Inactive--use PMC]`},
		{ID: `DVC`, Description: `DynPort Vaccine Company, LLC`, Comment: `CDC Changes made on: July 14, 2006`},
		{ID: `EVN`, Description: `Evans Medical Limited`, Comment: `[Inactive--use NOV]CDC Changes made on: July 14, 2006`},
		{ID: `GEO`, Description: `GeoVax Labs, Inc.`, Comment: `CDC Changes made on: July 14, 2006`},
		...
		{ID: `NOV`, Description: `Novartis Pharmaceutical Corporation`, Comment: `(includes Chiron, PowderJect Pharmaceuticals, Celltech Medeva Vaccines and Evans Limited, Ciba-Geigy Limited and Sandoz Limited)`},
		{ID: `NVX`, Description: `Novavax, Inc.`, Comment: `CDC Changes made on: July 14, 2006`},
		{ID: `NYB`, Description: `New York Blood Center`},
		{ID: `ORT`, Description: `Ortho-Clinical Diagnostics`, Comment: `(formerly Ortho Diagnostic Systems, Inc.)`},
		...
		{ID: `PMC`, Description: `sanofi pasteur`, Comment: `(formerly Aventis Pasteur, Pasteur Merieux Connaught; includes Connaught Laboratories and Pasteur Merieux) CDC Changes made on: Feb. 28, 2006`},
		{ID: `PRX`, Description: `Praxis Biologics`, Comment: `[Inactive--use WAL]`},
		{ID: `PWJ`, Description: `PowderJect Pharmaceuticals`, Comment: `(includes Celltech Medeva Vaccines and Evans Medical Limited) [Inactive--use NOV]CDC Changes made on: July 14, 2006`},
		{ID: `SCL`, Description: `Sclavo, Inc.`},
		{ID: `SI`, Description: `Swiss Serum and Vaccine Inst.`, Comment: `[Inactive--use BPC]`},
		{ID: `SKB`, Description: `GlaxoSmithKline`, Comment: `(formerly SmithKline Beecham; includes SmithKline Beecham and Glaxo Welcome)`},
		{ID: `SOL`, Description: `Solvay Pharmaceuticals`, Comment: `CDC Changes made on: July 14, 2006`},
		{ID: `TAL`, Description: `Talecris Biotherapeutics`, Comment: `(includes Bayer Biologicals) CDC Changes made on: Feb. 28, 2006`},
		{ID: `UNK`, Description: `Unknown manufacturer`},
		{ID: `USA`, Description: `United States Army Medical Research and Material Command`},
		{ID: `VXG`, Description: `VaxGen`, Comment: `CDC Changes made on: July 14, 2006`},
		{ID: `WA`, Description: `Wyeth-Ayerst`, Comment: `[Inactive--use WAL]`},
		{ID: `WAL`, Description: `Wyeth-Ayerst`, Comment: `(includes Wyeth-Lederle Vaccines and Pediatrics, Wyeth Laboratories, Lederle Laboratories, and Praxis Biologics)`},
		{ID: `ZLB`, Description: `ZLB Behring`, Comment: `(includes Aventis Behring and Armour Pharmaceutical Company) CDC Changes made on: Feb. 28, 2006`}}},
	...
	`0287`: {ID: `0287`, Name: `Problem/goal action code`, Row: []Row{
		...
		{ID: `UC`, Description: `UNCHANGED`, Comment: `The UNCHANGED action code is used to signify to the applications programs that this particular segment includes no information to be modified.  It is supplied in order to identify the correct record for which the following modification is intended. `},
	...
	`0291`: {ID: `0291`, Name: `Subtype of referenced data`, Row: []Row{
		{ID: `x-hl7-cda-level-one`, Description: `HL7 Clinical Document Architecture Level One document`, Comment: `Retained for backwards compatibility only as of v2.6 and CDA R 2. Preferred value is text/xml.`}}},
	`0292`: {ID: `0292`, Name: `Vaccines administered`, Row: []Row{
		...
		{ID: `105`, Description: `vaccinia (smallpox) diluted`, Comment: `vaccinia (smallpox) vaccine, diluted`},
		{ID: `106`, Description: `DTaP, 5 pertussis antigens 6`, Comment: `diphtheria, tetanus toxoids and acellular pertussis vaccine, 5 pertussis antigens`},
		{ID: `107`, Description: `DTaP, NOS`, Comment: `diphtheria, tetanus toxoids and acellular pertussis vaccine, NOS`},
		{ID: `108`, Description: `meningococcal, NOS`, Comment: `meningococcal vaccine, NOS Changes last made on May 10, 2006`},
		...
		{ID: `110`, Description: `DTaP-Hep B-IPV`, Comment: `DTaP-hepatitis B and poliovirus vaccine`},
		{ID: `111`, Description: `influenza, live, intranasal`, Comment: `influenza virus vaccine, live, attenuated, for intranasal use`},
		{ID: `112`, Description: `tetanus toxoid, NOS`, Comment: `tetanus toxoid, NOS`},
		{ID: `113`, Description: `Td (adult)`, Comment: `tetanus and diphtheria toxoids, adsorbed, preservative free, for adult use`},
		{ID: `114`, Description: `meningococcal A,C,Y,W-135 diphtheria conjugate`, Comment: `meningococcal polysaccharide (groups A, C, Y and W-135) diphtheria toxoid conjugate vaccine (MCV4)`},
		{ID: `115`, Description: `Tdap`, Comment: `tetanus toxoid, reduced diphtheria toxoid, and acellular pertussis vaccine, adsorbed Changes last made on May 10, 2006`},
		{ID: `116`, Description: `rotavirus, pentavalent`, Comment: `rotavirus, live, pentavalent vaccine Changes last made on Feb. 28, 2006`},
		{ID: `117`, Description: `VZIG (IND)`, Comment: `varicella zoster immune globulin (Investigational New Drug) Changes last made on Feb. 28, 2006`},
		{ID: `118`, Description: `HPV, bivalent`, Comment: `human papilloma virus vaccine, bivalent Changes last made on Feb. 28, 2006`},
		{ID: `119`, Description: `rotavirus, monovalent`, Comment: `rotavirus, live, monovalent vaccine Changes last made on Feb. 28, 2006`},
		{ID: `12`, Description: `diphtheria antitoxin`, Comment: `diphtheria antitoxin`},
		{ID: `120`, Description: `DTaP-Hib-IPV`, Comment: `diphtheria, tetanus toxoids and acellular pertussis vaccine, Haemophilus influenzae type b conjugate, and poliovirus vaccine, inactivated (DTaP-Hib-IPV) Changes last made on Feb. 28, 2006`},
		{ID: `121`, Description: `zoster`, Comment: `zoster vaccine, live Changes last made on June 1, 2006`},
		{ID: `122`, Description: `rotavirus, NOS 1`, Comment: `rotavirus vaccine, NOS Changes last made on June 1, 2006`},
		...
		{ID: `32`, Description: `meningococcal`, Comment: `meningococcal polysaccharide vaccine (MPSV4)`},
		...
		{ID: `35`, Description: `tetanus toxoid`, Comment: `tetanus toxoid, adsorbed`},
		...
		{ID: `62`, Description: `HPV, quadrivalent`, Comment: `human papilloma virus vaccine, quadrivalent Changes last made on Feb. 28, 2006`},
		...
		{ID: `74`, Description: `rotavirus, tetravalent`, Comment: `rotavirus, live, tetravalent vaccine Changes last made on Feb. 28, 2006`},
		{ID: `75`, Description: `vaccinia (smallpox)`, Comment: `vaccinia (smallpox) vaccine`},
		...
		{ID: `82`, Description: `adenovirus, NOS 1`, Comment: `adenovirus vaccine, NOS`},
		...
		{ID: `99`, Description: `RESERVED - do not use 3`, Comment: `RESERVED - do not use`},
		{ID: `998`, Description: `no vaccine administered 5`, Comment: `no vaccine administered`},
	...
	`0355`: {ID: `0355`, Name: `Primary key value type`, Row: []Row{
		{ID: `CE`, Description: `Coded element`, Comment: `Withdrawn as of v2.6 - CE has been replaced by CNE and CWE`},
	...
	`0365`: {ID: `0365`, Name: `Equipment state`, Row: []Row{
		{ID: ``, Description: `(null) No state change`},
	...
	`0366`: {ID: `0366`, Name: `Local/remote control state`, Row: []Row{
		...
		{ID: `New`, Description: `(null) No state change`},
	...
	`0376`: {ID: `0376`, Name: `Special Handling Code`, Row: []Row{
		{ID: `AMB`, Description: `Ambient temperature`, Comment: `Keep at ambient (room) temperature, approximately 22 ± 2 degrees C. Accidental refrigeration or freezing is of little consequence`},
		{ID: `C37`, Description: `Body temperature`, Comment: `Critical to keep at body temperature: 36 - 38° C.`},
		{ID: `CAMB`, Description: `Critical ambient temperature`, Comment: `Critical ambient - must not be refrigerated or frozen.`},
		{ID: `CATM`, Description: `Protect from air`, Comment: `Critical. Do not expose to atmosphere. Do not uncap.`},
		{ID: `CFRZ`, Description: `Critical frozen temperature`, Comment: `Critical frozen - must not be allowed to thaw until immediately prior to testing`},
		{ID: `CREF`, Description: `Critical refrigerated temperature`, Comment: `Critical refrigerated - must not be allowed to freeze or warm until immediately prior to testing`},
		{ID: `DFRZ`, Description: `Deep frozen`, Comment: `Deep frozen: -16 to -20° C.`},
		{ID: `DRY`, Description: `Dry`, Comment: `Keep in a dry environment.`},
		{ID: `FRZ`, Description: `Frozen temperature`, Comment: `Keep at frozen temperature: -4° C. Accidental thawing is of little consequence`},
		{ID: `MTLF`, Description: `Metal Free`, Comment: `Container is free of heavy metals including lead.`},
		{ID: `NTR`, Description: `Liquid nitrogen`, Comment: `Keep in liquid nitrogen.`},
		{ID: `PRTL`, Description: `Protect from light`, Comment: `Protect from light (e.g., wrap in aluminum foil).`},
		{ID: `PSA`, Description: `Do not shake`, Comment: `Do not shake.`},
		{ID: `PSO`, Description: `No shock`, Comment: `Protect from shock.`},
		{ID: `REF`, Description: `Refrigerated temperature`, Comment: `Keep at refrigerated temperature: 4-8° C. Accidental warming or freezing is of little consequence`},
		{ID: `UFRZ`, Description: `Ultra frozen`, Comment: `Ultra cold frozen: ~ -75 to -85° C. (ultra cold freezer is typically at temperature of dry ice).`},
		{ID: `UPR`, Description: `Upright`, Comment: `Keep upright. Do not turn upside down.`}}},
	...
	`0391`: {ID: `0391`, Name: `Segment group`, Row: []Row{
		...
		{ID: `CLOCK_AND_STATS_WITH_NOTES`},
		{ID: `CLOCK_AND_STATS_WITH_NOTES_ALT`},
		{ID: `COMMAND`},
		{ID: `COMMAND_RESPONSE`},
		{ID: `COMMON_ORDER`},
		{ID: `COMPONENT`},
	...
	`0396`: {ID: `0396`, Name: `Coding system`, Row: []Row{
		{ID: `99zzz or L`, Description: `Local general code (where z is an alphanumeric character) `},
		...
		{ID: `I10G2004`, Description: `ICD 10 Germany v2004 `},
		{ID: `I10G2005`, Description: `ICD 10 Germany v2005 `},
		{ID: `I10G2006`, Description: `ICD 10 Germany v2006 `},
		...
		{ID: `ISOnnnn`, Description: `ISO Defined Codes where nnnn is the ISO table number `},
		...
		{ID: `LN`, Description: `Logical Observation Identifier Names and Codes (LOINCÃ‚Â®) `},
	...
	`0440`: {ID: `0440`, Name: `Data types`, Row: []Row{
		{ID: `Address`, Description: `AD`, Comment: `Address`},
		{ID: `Authorization information`, Description: `AUI`, Comment: `Authorization information`},
		{ID: `Channel calibration parameters`, Description: `CCP`, Comment: `Channel calibration parameters`},
		{ID: `Channel definition`, Description: `CD`, Comment: `Channel definition`},
		{ID: `Channel Identifier`, Description: `WVI`, Comment: `Channel Identifier`},
		{ID: `Channel sensitivity`, Description: `CSU`, Comment: `Channel sensitivity`},
		{ID: `Charge code and date`, Description: `CCD`, Comment: `Charge code and date`},
		{ID: `Coded element`, Description: `CE`, Comment: `Coded element`},
		{ID: `Coded element with formatted values`, Description: `CF`, Comment: `Coded element with formatted values`},
		{ID: `Coded value for user-defined tables`, Description: `IS`, Comment: `Coded value for user-defined tables`},
		{ID: `Coded values for HL7 tables`, Description: `ID`, Comment: `Coded values for HL7 tables`},
		{ID: `Coded with exceptions`, Description: `CWE`, Comment: `Coded with exceptions`},
		{ID: `Coded with no exceptions`, Description: `CNE`, Comment: `Coded with no exceptions`},
		{ID: `Composite`, Description: `CM`, Comment: `Composite`},
		{ID: `Composite ID number and name`, Description: `CN`, Comment: `Composite ID number and name`},
		{ID: `Composite ID number and name simplified`, Description: `CNS`, Comment: `Composite ID number and name simplified`},
		{ID: `Composite ID with check digit`, Description: `CK`, Comment: `Composite ID with check digit`},
		{ID: `Composite price`, Description: `CP`, Comment: `Composite price`},
		{ID: `Composite quantity with units`, Description: `CQ`, Comment: `Composite quantity with units`},
		{ID: `Daily deductible information`, Description: `DDI`, Comment: `Daily deductible information`},
		{ID: `Data Type Name`, Description: `Data type`, Comment: `Data Type Name`},
		{ID: `Date`, Description: `DT`, Comment: `Date`},
		{ID: `Date and institution name`, Description: `DIN`, Comment: `Date and institution name`},
		{ID: `Date/time`, Description: `DTM`, Comment: `Date/time`},
		{ID: `Date/time range`, Description: `DR`, Comment: `Date/time range`},
		{ID: `Day type and number`, Description: `DTN`, Comment: `Day type and number`},
		{ID: `Delta`, Description: `DLT`, Comment: `Delta`},
		{ID: `Discharge to location and date`, Description: `DLD`, Comment: `Discharge to location and date`},
		{ID: `Driver's license number`, Description: `DLN`, Comment: `Driver's license number`},
		{ID: `Encapsulated data`, Description: `ED`, Comment: `Encapsulated data`},
		{ID: `Entity identifier`, Description: `EI`, Comment: `Entity identifier`},
		{ID: `Entity identifier pair`, Description: `EIP`, Comment: `Entity identifier pair`},
		{ID: `Error location`, Description: `ERL`, Comment: `Error location`},
		{ID: `Error location and description`, Description: `LD`, Comment: `Error location and description`},
		{ID: `Extended address`, Description: `XAD`, Comment: `Extended address`},
		{ID: `Extended composite ID number and name`, Description: `XCN`, Comment: `Extended composite ID number and name`},
		{ID: `Extended composite ID with check digit`, Description: `CX`, Comment: `Extended composite ID with check digit`},
		{ID: `Extended composite name and ID number for organizations`, Description: `XON`, Comment: `Extended composite name and ID number for organizations`},
		{ID: `Extended person name`, Description: `XPN`, Comment: `Extended person name`},
		{ID: `Extended telecommunications number`, Description: `XTN`, Comment: `Extended telecommunications number`},
		{ID: `Family name`, Description: `FN`, Comment: `Family name`},
		{ID: `Financial class`, Description: `FC`, Comment: `Financial class`},
		{ID: `Formatted text`, Description: `FT`, Comment: `Formatted text`},
		{ID: `General timing specification`, Description: `GTS`, Comment: `General timing specification`},
		{ID: `Hierarchic designator`, Description: `HD`, Comment: `Hierarchic designator`},
		{ID: `Insurance certification definition`, Description: `ICD`, Comment: `Insurance certification definition`},
		{ID: `Job code/class`, Description: `JCC`, Comment: `Job code/class`},
		{ID: `Location with address variation 1`, Description: `LA1`, Comment: `Location with address variation 1`},
		{ID: `Location with address variation 2`, Description: `LA2`, Comment: `Location with address variation 2`},
		{ID: `Message type`, Description: `MSG`, Comment: `Message type`},
		{ID: `Money`, Description: `MO`, Comment: `Money`},
		{ID: `Money and charge code`, Description: `MOC`, Comment: `Money and charge code`},
		{ID: `Money or percentage`, Description: `MOP`, Comment: `Money or percentage`},
		{ID: `Multiplexed array`, Description: `MA`, Comment: `Multiplexed array`},
		{ID: `Name with location and date`, Description: `NDL`, Comment: `Name with location and date`},
		{ID: `Numeric`, Description: `NM`, Comment: `Numeric`},
		{ID: `Numeric array`, Description: `NA`, Comment: `Numeric array`},
		{ID: `Numeric range`, Description: `NR`, Comment: `Numeric range`},
		{ID: `Occurrence code and date`, Description: `OCD`, Comment: `Occurrence code and date`},
		{ID: `Occurrence span code and date`, Description: `OSP`, Comment: `Occurrence span code and date`},
		{ID: `Order sequence definition`, Description: `OSD`, Comment: `Order sequence definition`},
		{ID: `Parent result link`, Description: `PRL`, Comment: `Parent result link`},
		{ID: `Performing person time stamp`, Description: `PPN`, Comment: `Performing person time stamp`},
		{ID: `Person location`, Description: `PL`, Comment: `Person location`},
		{ID: `Person name`, Description: `PN`, Comment: `Person name`},
		{ID: `Policy type and amount`, Description: `PTA`, Comment: `Policy type and amount`},
		{ID: `Practitioner institutional privileges`, Description: `PIP`, Comment: `Practitioner institutional privileges`},
		{ID: `Practitioner license or other ID number`, Description: `PLN`, Comment: `Practitioner license or other ID number`},
		{ID: `Processing type`, Description: `PT`, Comment: `Processing type`},
		{ID: `Query input parameter list`, Description: `QIP`, Comment: `Query input parameter list`},
		{ID: `Query selection criteria`, Description: `QSC`, Comment: `Query selection criteria`},
		{ID: `Reference pointer`, Description: `RP`, Comment: `Reference pointer`},
		{ID: `Reference range`, Description: `RFR`, Comment: `Reference range`},
		{ID: `Repeat interval`, Description: `RI`, Comment: `Repeat interval`},
		{ID: `Repeat pattern`, Description: `RPT`, Comment: `Repeat pattern`},
		{ID: `Room coverage`, Description: `RMC`, Comment: `Room coverage`},
		{ID: `Row column definition`, Description: `RCD`, Comment: `Row column definition`},
		{ID: `Scheduling class value pair`, Description: `SCV`, Comment: `Scheduling class value pair`},
		{ID: `Sequence ID`, Description: `SI`, Comment: `Sequence ID`},
		{ID: `Sort order`, Description: `SRT`, Comment: `Sort order`},
		{ID: `Specialty description`, Description: `SPD`, Comment: `Specialty description`},
		{ID: `Specimen source`, Description: `SPS`, Comment: `Specimen source`},
		{ID: `Street Address`, Description: `SAD`, Comment: `Street Address`},
		{ID: `String`, Description: `ST`, Comment: `String`},
		{ID: `Structured numeric`, Description: `SN`, Comment: `Structured numeric`},
		{ID: `Telephone number`, Description: `TN`, Comment: `Telephone number`},
		{ID: `Text data`, Description: `TX`, Comment: `Text data`},
		{ID: `Time`, Description: `TM`, Comment: `Time`},
		{ID: `Time stamp`, Description: `TS`, Comment: `Time stamp`},
		{ID: `Timing/quantity`, Description: `TQ`, Comment: `Timing/quantity`},
		{ID: `UB value code and amount`, Description: `UVC`, Comment: `UB value code and amount`},
		{ID: `Value range`, Description: `VR`, Comment: `Value range`},
		{ID: `Version identifier`, Description: `VID`, Comment: `Version identifier`},
		{ID: `Visiting hours`, Description: `VH`, Comment: `Visiting hours`},
		{ID: `Waveform source`, Description: `WVS`, Comment: `Waveform source`}}},
	...
	`0489`: {ID: `0489`, Name: `Risk Codes`, Row: []Row{
		{ID: `AGG`, Description: `Aggressive`, Comment: `A danger that can be associated with certain living subjects, including humans.`},
		{ID: `BHZ`, Description: `Biohazard`, Comment: `Material contains microorganisms that is an environmental hazard. Must be handled with special care.`},
		{ID: `BIO`, Description: `Biological`, Comment: `The dangers associated with normal biological materials. I.e. potential risk of unknown infections. Routine biological materials from living subjects.`},
		{ID: `COR`, Description: `Corrosive`, Comment: `Material is corrosive and may cause severe injury to skin, mucous membranes and eyes. Avoid any unprotected contact.`},
		{ID: `ESC`, Description: `Escape Risk`, Comment: `The entity is at risk for escaping from containment or control.`},
		{ID: `EXP`, Description: `Explosive`, Comment: `Material is an explosive mixture. Keep away from fire, sparks, and heat.`},
		{ID: `IFL`, Description: `MaterialDangerInflammable`, Comment: `Material is highly inflammable and in certain mixtures (with air) may lead to explosions. Keep away from fire, sparks and excessive heat.`},
		{ID: `INF`, Description: `MaterialDangerInfectious`, Comment: `Material known to be infectious with human pathogenic microorganisms. Those who handle this material must take precautions for their protection.`},
		{ID: `INJ`, Description: `Injury Hazard`, Comment: `Material is solid and sharp (e.g., cannulas.) Dispose in hard container.`},
		{ID: `POI`, Description: `Poison`, Comment: `Material is poisonous to humans and/or animals. Special care must be taken to avoid incorporation, even of small amounts.`},
		{ID: `RAD`, Description: `Radioactive`, Comment: `Material is a source for ionizing radiation and must be handled with special care to avoid injury of those who handle it and to avoid environmental hazards.`}}},
	...
	`0516`: {ID: `0516`, Name: `Error severity`, Row: []Row{
		...
		{ID: `F`, Description: `Fatal Error`, Comment: `Message not processed due to application or network failure condition`},
	...
	`0532`: {ID: `0532`, Name: `Expanded yes/no indicator`, Row: []Row{
		{ID: `ASKU`, Description: `asked but unknown`, Comment: `Information was sought but not found (e.g., patient was asked but didn't know`},
		{ID: `N`, Description: `No`},
		{ID: `NA`, Description: `not applicable`, Comment: `No proper value is applicable in this context (e.g., last menstrual period for a male)`},
		{ID: `NASK`, Description: `not asked`, Comment: `This information has not been sought (e.g., patient was not asked`},
		{ID: `NAV`, Description: `temporarily unavailable`, Comment: `Information is not available at this time but it is expected that it will be available later`},
		{ID: `NI`, Description: `No Information`, Comment: `No information whatsoever can be inferred from this exceptional value. This is the most general exceptional value. It is also the default exceptional value`},
		{ID: `NP`, Description: `not present`, Comment: `Value is not present in a message. This is only defined in messages, never in application data! All values not present in the message must be replaced by the applicable default, or no-information (NI) as the default of all defaults`},
		{ID: `UNK`, Description: `unknown`, Comment: `A proper value is applicable, but not known`},
		{ID: `Y`, Description: `Yes`}}},
	...
	`0550`: {ID: `0550`, Name: `Body Parts`, Row: []Row{
		...
		{ID: `CHEST`, Description: `Chest Tube`},
		...
		{ID: `NOSE`, Description: `Nose`},
		{ID: `NOSE`, Description: `Nose(Outside)`},
		{ID: `NOSTR`, Description: `Nostril`},
		{ID: `NP`, Description: `Nasopharyngeal`},
		{ID: `NP`, Description: `Nasopharynx`},
		...
		{ID: `PAROT`, Description: `Parotid`},
		{ID: `PAROT`, Description: `Parotid Gland`},
		...
		{ID: `THORA`, Description: `Thoracentesis`},
		{ID: `THORA`, Description: `Thorax/Thoracic`},
	...
	`0553`: {ID: `0553`, Name: `Invoice Control Code`, Row: []Row{
		...
		{ID: `CG`, Description: `Cancel Invoice Product/Service Group`, Comment: `Cancel a specific Product/Service Group in an Invoice`},
		{ID: `CL`, Description: `Cancel Invoice Product/Service Line Item`, Comment: `Cancel a specific Product/Service Line Item in an Invoice`},
		{ID: `CN`, Description: `Cancel Invoice`, Comment: `Can be used to reverse or cancel an invoice in progress or reverse a paid invoice. Receiver may only mark Invoice as cancelled, not purge records`},
		...
		{ID: `PD`, Description: `Pre-Determination Invoice`, Comment: `Can be used to submit an invoice through a Payer's edit and adjudication engine to determine if the invoice will be paid - does not result in payment by Payer`},
		{ID: `RA`, Description: `Re-Assessment`, Comment: `Used on EHC^E04 only`},
	...
	`0554`: {ID: `0554`, Name: `Invoice Reason Codes`, Row: []Row{
		{ID: `LATE`, Description: `Late Invoice`, Comment: `Over the Payer's published time limit for this invoice`},
	...
	`0555`: {ID: `0555`, Name: `Invoice Type`, Row: []Row{
		...
		{ID: `FN`, Description: `Final`, Comment: `Final Invoice`},
		{ID: `FS`, Description: `Fee for Service`},
		{ID: `GP`, Description: `Group`},
		{ID: `IN`, Description: `Information Only`, Comment: `Payee information not required for this Invoice Type`},
		{ID: `NP`, Description: `Non Patient`, Comment: `Invoice without a patient. E.g. bulk invoicing for Pharmacy for a care facility.`},
		{ID: `PA`, Description: `Partial`, Comment: `Partial Invoice`},
		{ID: `SL`, Description: `Salary`},
		{ID: `SS`, Description: `By Session`},
		{ID: `SU`, Description: `Supplemental`, Comment: `Supplemental Invoice`}}},
	...
	`0561`: {ID: `0561`, Name: `Product/Services Clarification Codes`, Row: []Row{
		...
		{ID: `DGAPP`, Description: `Diagnostic Approval Number`, Comment: `MSP: assigned by MSP`},
		{ID: `DTCTR`, Description: `Data Center Number`, Comment: `MSP: Data Center Number associated with the Provider's Network Application ID`},
		{ID: `ENC`, Description: `Encounter Number`},
		{ID: `GFTH`, Description: `Good Faith Indicator`},
		{ID: `OOP`, Description: `Out of Province Indicator`},
		{ID: `SEQ`, Description: `Sequence Number`, Comment: `MSP: Must be sequential by Data Center Number`}}},
	`0562`: {ID: `0562`, Name: `Processing Consideration Codes`, Row: []Row{
		{ID: `DFADJ`, Description: `Deferred Adjudication Processing`, Comment: `If permitted by Payer`},
		{ID: `EFORM`, Description: `Electronic form to follow`, Comment: `E30 transaction to follow`},
		{ID: `FAX`, Description: `Fax to follow`},
		{ID: `PAPER`, Description: `Paper documentation to follow`},
		{ID: `PYRDELAY`, Description: `Delayed by a Previous Payer`, Comment: `Allows Provider to explain lateness of Invoice to a subsequent Payer`},
		{ID: `RTADJ`, Description: `Real Time Adjudication Processing`, Comment: `If permitted by Payer`}}},
	`0564`: {ID: `0564`, Name: `Adjustment Category Code`, Row: []Row{
		{ID: `EA`, Description: `Edit/Adjudication Response`, Comment: `Payer adjustment`},
		{ID: `IN`, Description: `Information`, Comment: `Payer adjustment`},
		{ID: `PA`, Description: `Provider Adjustment`, Comment: `Provider adjustment`},
		{ID: `PR`, Description: `Processing Result`, Comment: `Payer adjustment`}}},
	...
	`0569`: {ID: `0569`, Name: `Adjustment Action`, Row: []Row{
		{ID: `EOB`, Description: `Print on EOB`, Comment: `Instructs party to print this adjustment on the EOB (Explanation of Benefits) handed to the patient`},
		{ID: `PAT`, Description: `Inform Patient`},
	...
	`0570`: {ID: `0570`, Name: `Payment Method Code`, Row: []Row{
		...
		{ID: `DDPO`, Description: `Direct Deposit`, Comment: `EFT`},
	...
	`0571`: {ID: `0571`, Name: `Invoice Processing Results Status`, Row: []Row{
		...
		{ID: `PRED`, Description: `Pre-Determination`, Comment: `Indicates that the IPR has been adjudicated but will not be paid. Equivalent to ADJUD (Adjudicate)`},
	...
	`0615`: {ID: `0615`, Name: `User Authentication Credential Type Code`, Row: []Row{
		{ID: `KERB`, Description: `Kerberos Service Ticket`, Comment: `Structure defined by RFC 1510`},
		{ID: `SAML`, Description: `Authenticated User Identity Assertion`, Comment: `XML structure defined by the OASIS Security Assertion Markup Language (SAML) specification`}}},
	`0616`: {ID: `0616`, Name: `Address Expiration Reason`, Row: []Row{
		{ID: `C`, Description: `Corrected`, Comment: `The address has been replaced with a corrected version`},
		{ID: `E`, Description: `Added in error`, Comment: `The address was incorrect and should never have been associated with the individual`},
		{ID: `M`, Description: `Moved`, Comment: `The individual associated with the address has moved and is no longer reachable at the address`},
		{ID: `R`, Description: `On request`, Comment: `The associated individual requested that the address be removed from their record`}}},
	`0617`: {ID: `0617`, Name: `Address Usage`, Row: []Row{
		{ID: `C`, Description: `Classification`, Comment: `Identifies an address used for the purpose of demographic classification or searching. Such addresses frequently contain insufficient information to be used as mailing or visit addresses. For example, they may only indicate country and postal code, without providing a street address.`},
		{ID: `M`, Description: `Mailing`, Comment: `Identifies an address for mail correspondence from a healthcare provider as stipulated by the subject. For example, under the tenets of certain privacy regulations, it is exclusive to the patient and is typically maintained at the encounter or visit level versus the person level as it only has relevance to the specifics of a given encounter. This is an exception category of address in that the patient has stipulated that they want all correspondence relevant to a given encounter sent to this address in lieu of any other address on file. Providers are required to accommodate such requests under HIPAA promulgated regulation. Note that mailing and legal address may be mutually exclusive as defined below. (Implementors are reminded that although the privacy regulation requires the provider to honor such requests, it does require the provider to enquire whether the patient has a preferred address other than the one volunteered.)`},
		{ID: `V`, Description: `Visit`, Comment: `Identifies an address at which the individual is physically located and may be visited.`}}},
	...
	`0625`: {ID: `0625`, Name: `Item Status Codes`, Row: []Row{
		{ID: `1`, Description: `Active`, Comment: `Item is available to be purchased or issued.`},
		{ID: `2`, Description: `Pending Inactive`, Comment: `Item is not available to be purchased, but is available to be issued.`},
		{ID: `3`, Description: `Inactive`, Comment: `Item is not available to be purchased or issued.`}}},
	`0634`: {ID: `0634`, Name: `Item Importance Codes`, Row: []Row{
		{ID: `CRT`, Description: `Critical`}}},
	`0642`: {ID: `0642`, Name: `Reorder Theory Codes`, Row: []Row{
		{ID: `D`, Description: `DOP/DOQ`, Comment: `Corresponds to the theory that calculates the appropriate order point and recommends the quantity to order based on system parameters and historical trends. DOP stands for Dynamic Order Point, and DOQ stands for Dynamic Order Quantity.`},
		{ID: `M`, Description: `MIN/MAX`, Comment: `Corresponds to theory - the quantity recommended is the Order Quantity, less the On Hand Quantity, and less the On Order Quantity. The Order Amount is the desired Maximum On Hand Quantity.`},
		{ID: `O`, Description: `Override`, Comment: `The quantity recommended is the Order Quantity, less the On Order Quantity. The Order Amount is the amount to order when the On Hand reaches the Order Point.`}}},
	...
	`0653`: {ID: `0653`, Name: `Date Format`, Row: []Row{
		{ID: `1`, Description: `mm/dd/yy`, Comment: `USA standard`},
		{ID: `2`, Description: `yy.mm.dd`, Comment: `ANSI standard`},
		{ID: `3`, Description: `dd/mm/yy`, Comment: `Britain/France standard`},
		{ID: `4`, Description: `dd.mm.yy`, Comment: `Germany standard`},
		{ID: `5`, Description: `yy/mm/dd`, Comment: `Japan standard`},
		{ID: `6`, Description: `Yymmdd`, Comment: `ISO standard`}}},
	...
	`0667`: {ID: `0667`, Name: `Device Data State`, Row: []Row{
		{ID: `0`, Description: `Real Time Values`, Comment: `Display data`},
		{ID: `1`, Description: `Historic Values`, Comment: `Print data`}}},
	`0669`: {ID: `0669`, Name: `Load Status`, Row: []Row{
		{ID: `LCC`, Description: `Load is Complete`, Comment: `The load is complete`},
		{ID: `LCN`, Description: `Load Canceled`, Comment: `The load is canceled`},
		{ID: `LCP`, Description: `Load In Process`, Comment: `The load is running`},
		{ID: `LLD`, Description: `Building a Load`, Comment: `A load is being built`}}},
	`0682`: {ID: `0682`, Name: `Device Status`, Row: []Row{
		{ID: `0`, Description: `Ready`, Comment: `Door Locked`},
		{ID: `1`, Description: `Not Ready`, Comment: `Door Unlocked`}}},
	`0702`: {ID: `0702`, Name: `Cycle Type`, Row: []Row{
		{ID: `2RS`, Description: `Second Rinse`},
		{ID: `ANR`, Description: `Anesthesia/Respiratory`, Comment: `Special Wash cycle`},
		{ID: `BDP`, Description: `Bedpans`},
		{ID: `BWD`, Description: `Bowie-Dick Test`, Comment: `A Bowie-Dick test cycle is a special cycle used to test the integrity of the sterilizer chamber to hold a vacuum.`},
		{ID: `CMW`, Description: `Chemical Wash`, Comment: `A chemical wash cycle.`},
		{ID: `COD`, Description: `Code`},
		{ID: `CRT`, Description: `Cart Wash`},
		{ID: `DEC`, Description: `Decontamination`},
		{ID: `DRT`, Description: `Dart`, Comment: `A dart cycle is a special cycle used to test the integrity of the sterilizer chamber to hold a vacuum.`},
		{ID: `DRW`, Description: `Dart Warm-up Cycle`, Comment: `A dart warm-up cycle is used to bring the sterilizer chamber up to operating temperature in order to run a dart test cycle.`},
		{ID: `EOH`, Description: `EO High Temperature`},
		{ID: `EOL`, Description: `EO Low Temperature`},
		{ID: `EXP`, Description: `Express`, Comment: `An express cycle is similar to a flash cycle but the supply item is wrapped.`},
		{ID: `FLS`, Description: `Flash`, Comment: `Used to quickly sterilize instruments that were dropped during surgery.`},
		{ID: `GLS`, Description: `Glassware`},
		{ID: `GNP`, Description: `Gen. Purpose`},
		{ID: `GRV`, Description: `Gravity`, Comment: `A gravity cycle is executed at atmospheric pressure.`},
		{ID: `GTL`, Description: `Gentle`},
		{ID: `ISO`, Description: `Isothermal`},
		{ID: `IST`, Description: `Instrument Wash`},
		{ID: `LKT`, Description: `Leak Test`, Comment: `A leak test cycle tests the integrity of the sterilizer chamber to hold a vacuum over a specific period of time.`},
		{ID: `LQD`, Description: `Liquid`, Comment: `A cycle specific to sterilizing liquids.`},
		{ID: `OPW`, Description: `Optional Wash`, Comment: `Any Optional Wash cycle`},
		{ID: `PEA`, Description: `Peracetic Acid`, Comment: `A peracetic acid cycle.`},
		{ID: `PLA`, Description: `Plastic Goods Wash`},
		{ID: `PRV`, Description: `Prevac`, Comment: `A prevac cycle is vacuum assisted.`},
		{ID: `RNS`, Description: `Rinse`},
		{ID: `SFP`, Description: `Steam Flush Pressure Pulse`, Comment: `An SFPP cycle uses steam pulses instead of a vacuum during the conditioning phase of the cycle when the supply item is wrapped.`},
		{ID: `THR`, Description: `Thermal`},
		{ID: `TRB`, Description: `Tray/Basin`},
		{ID: `UTL`, Description: `Utensil Wash`},
		{ID: `WFP`, Description: `Wrap/Steam Flush Pressure Pulse (Wrap/SFPP)`, Comment: `A Wrap/SFPP cycle uses steam pulses instead of a vacuum during the conditioning phase of the cycle when the supply item is unwrapped.`}}},
	...
	`0725`: {ID: `0725`, Name: `Mood Codes`, Row: []Row{
		...
		{ID: `EVN.CRT`, Description: `Event Criterion`, Comment: `Criterion applying to Events for another Service to be applied. This is an Act Mood PredicateSimilar uses of above moods may be defined.Eg Use in Care Plans,`},
	...
	`0776`: {ID: `0776`, Name: `Item Status`, Row: []Row{
		{ID: `A`, Description: `Active`, Comment: `Item is available to be purchased or issued.`},
		{ID: `I`, Description: `Inactive`, Comment: `Item is not available to be purchased or issued.`},
		{ID: `P`, Description: `Pending Inactive`, Comment: `Item is not available to be purchased, but is available to be issued.`}}},
	...
	`0834`: {ID: `0834`, Name: `MIME Types`, Row: []Row{
		...
		{ID: `model`, Description: `Model data`, Comment: `RFC 2077`},
		{ID: `multipart`, Description: `MIME multipart package`},
	...
	`0868`: {ID: `0868`, Name: `Telecommunication expiration reason`, Row: []Row{
		{ID: `C`, Description: `Corrected`, Comment: `The telecommunication address has been replaced with a corrected version`},
		{ID: `E`, Description: `Added in error`, Comment: `The telecommunication address was incorrect and should never have been associated with the individual`},
		{ID: `M`, Description: `Moved`, Comment: `The individual associated with the telecommunication address has moved and is no longer reachable at the address`},
		{ID: `N`, Description: `No longer in service`, Comment: `The telecommunication address is no longer connected or available`},
		{ID: `R`, Description: `On request`, Comment: `The associated individual requested that the telecommunication address be removed from their record (though it may still be correct).`}}},
	`0871`: {ID: `0871`, Name: `Supply Risk Codes`, Row: []Row{
		{ID: `COR`, Description: `Corrosive`, Comment: `Material is corrosive and may cause severe injury to skin, mucous membranes and eyes. Avoid any unprotected contact.`},
		{ID: `EXP`, Description: `Explosive`, Comment: `Material is an explosive mixture. Keep away from fire, sparks, and heat.`},
		{ID: `FLA`, Description: `Flammable`, Comment: `Material is highly flammable and in certain mixtures (with air) may lead to explosions. Keep away from fire, sparks and excessive heat.`},
		{ID: `INJ`, Description: `Injury Hazard`, Comment: `Material is solid and sharp (e.g., cannulas.) Dispose in hard container.`},
		{ID: `RAD`, Description: `Radioactive`, Comment: `Material is a source for ionizing radiation and must be handled with special care to avoid injury of those who handle it and to avoid environmental hazards.`},
		{ID: `TOX`, Description: `Toxic`, Comment: `Material is toxic to humans and/or animals. Special care must be taken to avoid incorporation, even of small amounts.`},
		{ID: `UNK`, Description: `Unknown`, Comment: `Material hazard level is unknown.`}}},
...
var TableValueLookup = map[string]map[string]bool{
	...
	`0391`: {
		...
		`CLOCK_AND_STATS_WITH_NOTES`:     true,
		`CLOCK_AND_STATS_WITH_NOTES_ALT`: true,
		`COMMAND`:                        true,
	...
	`0440`: {
		`Address`:                                 true,
		`Authorization information`:               true,
		`Channel calibration parameters`:          true,
		`Channel definition`:                      true,
		`Channel Identifier`:                      true,
		`Channel sensitivity`:                     true,
		`Charge code and date`:                    true,
		`Coded element`:                           true,
		`Coded element with formatted values`:     true,
		`Coded value for user-defined tables`:     true,
		`Coded values for HL7 tables`:             true,
		`Coded with exceptions`:                   true,
		`Coded with no exceptions`:                true,
		`Composite`:                               true,
		`Composite ID number and name`:            true,
		`Composite ID number and name simplified`: true,
		`Composite ID with check digit`:           true,
		`Composite price`:                         true,
		`Composite quantity with units`:           true,
		`Daily deductible information`:            true,
		`Data Type Name`:                          true,
		`Date`:                                    true,
		`Date and institution name`:               true,
		`Date/time`:                               true,
		`Date/time range`:                         true,
		`Day type and number`:                     true,
		`Delta`:                                   true,
		`Discharge to location and date`:          true,
		`Driver's license number`:                 true,
		`Encapsulated data`:                       true,
		`Entity identifier`:                       true,
		`Entity identifier pair`:                  true,
		`Error location`:                          true,
		`Error location and description`:          true,
		`Extended address`:                        true,
		`Extended composite ID number and name`:   true,
		`Extended composite ID with check digit`:  true,
		`Extended composite name and ID number for organizations`: true,
		`Extended person name`:                    true,
		`Extended telecommunications number`:      true,
		`Family name`:                             true,
		`Financial class`:                         true,
		`Formatted text`:                          true,
		`General timing specification`:            true,
		`Hierarchic designator`:                   true,
		`Insurance certification definition`:      true,
		`Job code/class`:                          true,
		`Location with address variation 1`:       true,
		`Location with address variation 2`:       true,
		`Message type`:                            true,
		`Money`:                                   true,
		`Money and charge code`:                   true,
		`Money or percentage`:                     true,
		`Multiplexed array`:                       true,
		`Name with location and date`:             true,
		`Numeric`:                                 true,
		`Numeric array`:                           true,
		`Numeric range`:                           true,
		`Occurrence code and date`:                true,
		`Occurrence span code and date`:           true,
		`Order sequence definition`:               true,
		`Parent result link`:                      true,
		`Performing person time stamp`:            true,
		`Person location`:                         true,
		`Person name`:                             true,
		`Policy type and amount`:                  true,
		`Practitioner institutional privileges`:   true,
		`Practitioner license or other ID number`: true,
		`Processing type`:                         true,
		`Query input parameter list`:              true,
		`Query selection criteria`:                true,
		`Reference pointer`:                       true,
		`Reference range`:                         true,
		`Repeat interval`:                         true,
		`Repeat pattern`:                          true,
		`Room coverage`:                           true,
		`Row column definition`:                   true,
		`Scheduling class value pair`:             true,
		`Sequence ID`:                             true,
		`Sort order`:                              true,
		`Specialty description`:                   true,
		`Specimen source`:                         true,
		`Street Address`:                          true,
		`String`:                                  true,
		`Structured numeric`:                      true,
		`Telephone number`:                        true,
		`Text data`:                               true,
		`Time`:                                    true,
		`Time stamp`:                              true,
		`Timing/quantity`:                         true,
		`UB value code and amount`:                true,
		`Value range`:                             true,
		`Version identifier`:                      true,
		`Visiting hours`:                          true,
		`Waveform source`:                         true},
	`0441`: {
		`A`: true,
		`I`: true,
		`L`: true,
