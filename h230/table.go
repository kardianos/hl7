...
var TableLookup = map[string]Table{
	...
	`0003`: {ID: `0003`, Name: `Event type`, Row: []Row{
		...
		{ID: `CNQ`, Description: `QRY/EQQ/VQQ/RQQ - Cancel query`},
		...
		{ID: `T09`, Description: `MDM/ACK - Document cancel notification`},
	...
	`0076`: {ID: `0076`, Name: `Message type`, Row: []Row{
		...
		{ID: `ARD`, Description: `Ancillary RPT (display)`},
		...
		{ID: `ERQ`, Description: `Event replay query`},
		...
		{ID: `ORF`, Description: `Observation result/record response`},
		{ID: `ORM`, Description: `Order message`},
		{ID: `ORR`, Description: `Order acknowledgment message`},
		{ID: `ORU`, Description: `Observation result/unsolicited`},
		...
		{ID: `PGQ`, Description: `Patient goal query`},
		{ID: `PGR`, Description: `Patient goal response`},
		{ID: `PIN`, Description: `Patient Insurance Information`},
		{ID: `PIN`, Description: `Patient information`},
		{ID: `PPP`, Description: `Patient pathway (problem-oriented)`},
		{ID: `PPR`, Description: `Patient problem`},
		{ID: `PPR`, Description: `Patient problem`},
		{ID: `PPT`, Description: `Patient pathway (goal oriented)`},
		{ID: `PPV`, Description: `Patient goal response`},
		{ID: `PRQ`, Description: `Patient care problem query`},
		{ID: `PRR`, Description: `Patient problem response`},
		{ID: `PTQ`, Description: `Patient pathway (problem-oriented) query`},
		{ID: `PTR`, Description: `Patient pathway (problem-oriented) response`},
		{ID: `PTU`, Description: `Patient pathway (goal-oriented) query`},
		{ID: `PTV`, Description: `Patient pathway (goal-oriented) response`},
		...
		{ID: `ROC`, Description: `Request clinical information`},
		{ID: `ROD`, Description: `Request patient demographics`},
	...
	`0093`: {ID: `0093`, Name: `Release information`, Row: []Row{
		{ID: `*`, Description: `or user-defined codes`},
		{ID: `N`, Description: `No`},
	...
	`0131`: {ID: `0131`, Name: `Contact role`, Row: []Row{
		{ID: `BP`, Description: `Billing contact person`},
		{ID: `CP`, Description: `Contact person`},
		{ID: `EP`, Description: `Emergency contact person`},
		{ID: `PR`, Description: `Person preparing referral`}}},
	...
	`0142`: {ID: `0142`, Name: `Champus Status`, Row: []Row{}},
	...
	`0200`: {ID: `0200`, Name: `Name type`, Row: []Row{
		...
		{ID: `L`, Description: `Legal Name`, Comment: `The legal name is the same as the current married name`},
		{ID: `M`, Description: `Maiden Name`},
		{ID: `O`, Description: `Other`}}},
	`0201`: {ID: `0201`, Name: `Telecommunicationuse code`, Row: []Row{
	...
	`0202`: {ID: `0202`, Name: `Telecommunicationequipment type`, Row: []Row{
	...
	`0211`: {ID: `0211`, Name: `Alternate character sets`, Row: []Row{
		...
		{ID: `JAS2020`, Description: `A subset of ISO2020 used for most Kanjii transmissions`},
		{ID: `JIS X 0202`, Description: `ISO 2022 with escape sequences for Kanjii`},
	...
	`0227`: {ID: `0227`, Name: `Manufacturers of vaccines`, Row: []Row{
		{ID: `AB`, Description: `Abbott`},
		{ID: `AD`, Description: `Adams`},
		{ID: `ALP`, Description: `Alpha`},
		{ID: `AR`, Description: `Armour`},
		{ID: `BA`, Description: `Baxter`},
		{ID: `BAY`, Description: `Bayer`},
		{ID: `BP`, Description: `Berna`},
		{ID: `CON`, Description: `Connaught`},
		{ID: `EVN`, Description: `Evans`},
		{ID: `GRE`, Description: `Greer`},
		{ID: `IM`, Description: `Merieux`},
		{ID: `IUS`, Description: `Immuno-US`},
		{ID: `JPN`, Description: `Microbial Dis/Osaka U`},
		{ID: `KGC`, Description: `Korea Green Cross`},
		{ID: `LED`, Description: `Lederle`},
		{ID: `MA`, Description: `Massachusetts Public Health`},
		{ID: `MIL`, Description: `Miles`},
		{ID: `MIP`, Description: `Michigan Dept Public Health`},
		{ID: `MSD`, Description: `Merck`},
		{ID: `NAB`, Description: `North American Biologicals`},
		{ID: `NYB`, Description: `New York Blood Center`},
		{ID: `OTC`, Description: `Organon Teknika`},
		{ID: `OTH`, Description: `Other`},
		{ID: `PD`, Description: `Parke Davis`},
		{ID: `PRX`, Description: `Praxis Biologics`},
		{ID: `SCL`, Description: `Sclavo`},
		{ID: `SI`, Description: `Swiss Serum and Vaccine Inst.`},
		{ID: `SKB`, Description: `SmithKline`},
	...
	`0272`: {ID: `0272`, Name: `Document confidentiality status`, Row: []Row{
		{ID: `RE`, Description: `Restricted`},
		{ID: `UC`, Description: `Usual control`},
		{ID: `VR`, Description: `Very restricted`}}},
	...
	`0277`: {ID: `0277`, Name: `Appointment type codes`, Row: []Row{
		{ID: `COMPLETE`, Description: `A request to add a completed appointment, used to maintain records of completed appointments that did not appear in the schedule (e.g., STAT, w alk-in, etc.)`},
	...
	`0278`: {ID: `0278`, Name: `Filler status codes`, Row: []Row{
		{ID: `BLOCKED`, Description: `The indicated time slot(s) is(are) blocked. Not used in the AIS,  AIG,  AIL,  AIP segments.`},
		{ID: `BOOKED`, Description: `The indicated appointment is booked`},
		{ID: `CANCELLED`, Description: `The indicated appointment was stopped from occurring (cancelled prior to starting)`},
		{ID: `COMPLETE`, Description: `The indicated appointment has completed normally (was not discontinued, canceled, or deleted)`},
		{ID: `DC`, Description: `The indicated appointment was discontinued (DCed while in progress, discontinued parent appointment,  or discontinued child appointment)`},
	...
	`0310`: {ID: `0310`, Name: `Handicap`, Row: []Row{}},
