...
//
// Usage Notes:
// Fields 2-9.  These are not applicable ("n/a") when the type of change being requested or reported is start-up or shut-down.
// If the change is of type "M", at least one of fields 2-5 must be different from its corresponding field in range 6-9.
...
type OBR struct {
	...
	RelevantClinicalInformation                ST      `hl7:"13,display=Relevant Clinical Information"`
