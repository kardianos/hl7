...
var TableLookup = map[string]Table{
	...
	`0003`: {ID: `0003`, Name: `Event type`, Row: []Row{
		{ID: `022`, Description: `ORL - General laboratory order response message to any OML`},
		...
		{ID: `K11`, Description: `RSP - Segment pattern response`},
		{ID: `K13`, Description: `RTB - Tabular response`},
		{ID: `K15`, Description: `RDY - Display response`},
		...
		{ID: `QNC`, Description: `Varies - Query cancellation`},
	...
	`0070`: {ID: `0070`, Name: `Specimen source codes`, Row: []Row{
		...
		{ID: `XXX`, Description: `To be specified in another part of the message`}}},
	...
	`0074`: {ID: `0074`, Name: `Diagnostic service section ID`, Row: []Row{
		...
		{ID: `IMG`, Description: `Diagnostic Imaging`},
		...
		{ID: `PAR`, Description: `Parasitology`},
		{ID: `PAT`, Description: `Pathology (gross & histopath, not surgical)`},
	...
	`0076`: {ID: `0076`, Name: `Message type`, Row: []Row{
		...
		{ID: `ESR`, Description: `Automated equipment status update acknowledgement message`},
		...
		{ID: `MCF`, Description: `Delayed Acknowledgement (Retained for backward compatibility only)`},
		...
		{ID: `ORD`, Description: `Dietary order - General order acknowledgment message`},
		{ID: `ORF`, Description: `Query for results of observation`},
		{ID: `ORG`, Description: `General clinical order acknowledgement message`},
		{ID: `ORL`, Description: `Laboratory acknowledgement message (unsolicited)`},
		...
		{ID: `ORP`, Description: `Pharmacy/treatment order acknowledgement message`},
		{ID: `ORR`, Description: `General order response message response to any ORM`},
		{ID: `ORS`, Description: `Stock requisition - General order acknowledgment message`},
		...
		{ID: `RRA`, Description: `Pharmacy/treatment administration acknowledgement message`},
	...
	`0119`: {ID: `0119`, Name: `Order control codes`, Row: []Row{
		{ID: `AF`, Description: `ORR^O02`, Comment: `Order/service refill request approval`},
		{ID: `CA`, Description: `ORM^O01`, Comment: `Cancel order/service request`},
		{ID: `CH`, Description: `ORM^O01`, Comment: `Child order/service`},
		{ID: `CN`, Description: `ORU^R01`, Comment: `Combined result`},
		{ID: `CR`, Description: `ORR^O02`, Comment: `Canceled as requested`},
		{ID: `DC`, Description: `ORM^O01`, Comment: `Discontinue order/service request`},
		{ID: `DE`, Description: `ORM^O01`, Comment: `Data errors`},
		{ID: `DE`, Description: `ORS^O06`, Comment: `Data errors`},
		{ID: `DF`, Description: `ORR^O02`, Comment: `Order/service refill request denied`},
		{ID: `DR`, Description: `ORR^O02`, Comment: `Discontinued as requested`},
		{ID: `FU`, Description: `ORM^O01`, Comment: `"Order/service refilled, unsolicited"`},
		{ID: `HD`, Description: `ORM^O01`, Comment: `Hold order request`},
		{ID: `HR`, Description: `ORR^O02`, Comment: `On hold as requested`},
		{ID: `HR`, Description: `ORD^O04`, Comment: `On hold as requested`},
		{ID: `LI`, Description: `ORM^O01`, Comment: `Link order/service to patient care problem or goal`},
		{ID: `LI`, Description: `OMP^O09`, Comment: `Link order/service to patient care problem or goal`},
		{ID: `NA`, Description: `ORR^O02`, Comment: `Number assigned`},
		{ID: `NW`, Description: `ORM^O01`, Comment: `New order/service`},
		{ID: `OC`, Description: `ORM^O01`, Comment: `Order/service canceled`},
		{ID: `OD`, Description: `ORM^O01`, Comment: `Order/service discontinued`},
		{ID: `OE`, Description: `ORM^O01`, Comment: `Order/service released`},
		{ID: `OF`, Description: `ORR^O02`, Comment: `Order/service refilled as requested`},
		{ID: `OH`, Description: `ORM^O01`, Comment: `Order/service held`},
		{ID: `OK`, Description: `ORR^O02`, Comment: `Order/service accepted & OK`},
		{ID: `OR`, Description: `ORR^O02`, Comment: `Released as requested`},
		{ID: `PA`, Description: `ORM^O01`, Comment: `Parent order/service`},
		{ID: `PR`, Description: `ORM^O01`, Comment: `Previous Results with new order/service`},
		{ID: `RE`, Description: `ORM^O01`, Comment: `Observations/Performed Service to follow`},
		{ID: `RF`, Description: `ORM^O01`, Comment: `Refill order/service request`},
		{ID: `RL`, Description: `ORM^O01`, Comment: `Release previous hold`},
		{ID: `RO`, Description: `ORM^O01`, Comment: `Replacement order`},
		{ID: `RP`, Description: `ORM^O01`, Comment: `Order/service replace request`},
		{ID: `RQ`, Description: `ORR^O02`, Comment: `Replaced as requested`},
		{ID: `RR`, Description: `ORR^O02`, Comment: `Request received`},
		{ID: `RU`, Description: `ORM^O01`, Comment: `Replaced unsolicited`},
		{ID: `SC`, Description: `ORM^O01`, Comment: `Status changed`},
		{ID: `SN`, Description: `ORM^O01`, Comment: `Send order/service number`},
		{ID: `SR`, Description: `ORR^O02`, Comment: `Response to send order/service status request`},
		{ID: `SS`, Description: `ORM^O01`, Comment: `Send order/service status request`},
		{ID: `UA`, Description: `ORR^O02`, Comment: `Unable to accept order/service`},
		{ID: `UA`, Description: `RRG^O16`, Comment: `Unable to accept order/service`},
		{ID: `UC`, Description: `ORR^O02`, Comment: `Unable to cancel`},
		{ID: `UC`, Description: `ORD^O04`, Comment: `Unable to cancel`},
		{ID: `UD`, Description: `ORR^O02`, Comment: `Unable to discontinue`},
		{ID: `UD`, Description: `ORD^O04`, Comment: `Unable to discontinue`},
		{ID: `UF`, Description: `ORR^O02`, Comment: `Unable to refill`},
		{ID: `UH`, Description: `ORR^O02`, Comment: `Unable to put on hold`},
		{ID: `UM`, Description: `ORR^O02`, Comment: `Unable to replace`},
		{ID: `UM`, Description: `ORG^O20`, Comment: `Unable to replace`},
		{ID: `UN`, Description: `ORM^O01`, Comment: `Unlink order/service from patient care problem or goal`},
		{ID: `UR`, Description: `ORR^O02`, Comment: `Unable to release`},
		{ID: `UR`, Description: `ORD^O04`, Comment: `Unable to release`},
		{ID: `UX`, Description: `ORR^O02`, Comment: `Unable to change`},
		{ID: `XO`, Description: `ORM^O01`, Comment: `Change order/service request`},
		{ID: `XO`, Description: `OMP^O09`, Comment: `Change order/service request`},
		{ID: `XR`, Description: `ORR^O02`, Comment: `Changed as requested`},
		{ID: `XX`, Description: `ORM^O01`, Comment: `"Order/service changed, unsol."`}}},
	...
	`0175`: {ID: `0175`, Name: `Master file identifier code`, Row: []Row{
		...
		{ID: `OME`, Description: `Other basic observation/service attributes`},
	...
	`0203`: {ID: `0203`, Name: `Identifier type`, Row: []Row{
		...
		{ID: `U`, Description: `Unspecified`},
		{ID: `UPIN`, Description: `Medicare/HCFA’s Universal Physician Identification numbers`},
	...
	`0211`: {ID: `0211`, Name: `Alternate character sets`, Row: []Row{
		...
		{ID: `ISO IR14`, Description: `Code for Information Exchange (one byte)(JIS X 0201-1976). Note that the code contains a space, i.e. "ISO IR14".`},
	...
	`0216`: {ID: `0216`, Name: `Patient status`, Row: []Row{}},
	...
	`0227`: {ID: `0227`, Name: `Manufacturers of vaccines`, Row: []Row{
		{ID: `AB`, Description: `Abbott Laboratories (includes Ross Products Division)`},
		...
		{ID: `BPC`, Description: `Berna Products Corporation (includes Swiss Serum and Vaccine Institute Berne)`},
		...
		{ID: `EVN`, Description: `Evans Medical Limited (an affiliate of Medeva Pharmaceuticals, Inc.)`},
		...
		{ID: `MIP`, Description: `Bioport Corporation (formerly Michigan Biologic Products Institute)`},
		...
		{ID: `NOV`, Description: `Novartis Pharmaceutical Corporation (includes Ciba-Geigy Limited and Sandoz Limited)`},
		...
		{ID: `PD`, Description: `Parkedale Pharmaceuticals (formerly Parke-Davis)`},
		{ID: `PMC`, Description: `Aventis Pasteur Inc. (formerly Pasteur Merieux Connaught; includes Connaught Laboratories and Pasteur Merieux)`},
	...
	`0292`: {ID: `0292`, Name: `Vaccines administered`, Row: []Row{
		...
		{ID: `42`, Description: `Hep B, adolescent/high risk infant2`, Comment: `hepatitis B vaccine, adolescent/high risk infant dosage`},
		...
		{ID: `99`, Description: `RESERVED - do not use3`, Comment: `RESERVED - do not use`},
	...
	`0301`: {ID: `0301`, Name: `Universal ID type`, Row: []Row{
		...
		{ID: `Random`, Comment: `Usually a base64 encoded string of random bits. The uniqueness depends on the length of the bits. Mail systems often generate ASCII string "unique names" from a combination of random bits and system names. Obviously, such identifiers will not be constrained to the base64 character set.`},
	...
	`0335`: {ID: `0335`, Name: `Repeat pattern`, Row: []Row{
		...
		{ID: `BID`, Description: `twice a day at institution-specified times (e.g., 9AM-4PM)`},
		{ID: `C`, Description: `service is provided continuously between start time and stop time`},
		{ID: `D`, Description: `Cibus Diurnus (lunch)`},
		{ID: `I`, Description: `Inter (e.g., between this meal and the next, between dinner and sleep`},
		{ID: `M`, Description: `Cibus Matutinus (breakfast)`},
		{ID: `Meal Related Timings`, Description: `<timing>C (“cum”)<meal>`},
		{ID: `Once`, Description: `one time only. This is also the default when this component is null.`},
		{ID: `P`, Description: `Post (after)`},
		{ID: `PRN`, Description: `given as needed`},
		{ID: `PRNxxx`, Description: `where xxx is some frequency code (e.g., PRNQ6H); given as needed over the frequency period.`},
		{ID: `Q<integer>D`, Description: `every <integer> days`},
		{ID: `Q<integer>H`, Description: `every <integer> hours`},
		{ID: `Q<integer>J<day#>`, Description: `repeats on a particular day of the week, from the French jour (day). If <integer> is missing, the repeat rate is assumed to be 1. Day numbers are counted from 1=Monday to 7=Sunday. So Q2J2 means every second Tuesday; Q1J6 means every Saturday.`},
		...
		{ID: `QID`, Description: `four times a day at institution-specified times (e.g., 9AM-11AM-4PM-9PM)`},
		{ID: `QOD`, Description: `every other day (same as Q2D)`},
		...
		{ID: `TID`, Description: `three times a day at institution-specified times (e.g., 9AM-4PM-9PM)`},
		...
		{ID: `xID`, Description: `“X” times per day at institution-specified times, where X is a numeral 5 or greater. E.g., 5ID=five times per day; 8ID=8 times per day`}}},
	...
	`0351`: {ID: `0351`, Name: `Occurrence span`, Row: []Row{
		...
		{ID: `M0`, Description: `PSRO/UR approved stay dates`}}},
	`0354`: {ID: `0354`, Name: `Message structure`, Row: []Row{
		...
		{ID: `ORL_O22`, Description: `022`},
		{ID: `ORM_O01`, Description: `O01`},
		{ID: `ORN_008`, Description: `O08`},
		...
		{ID: `PMU_B04`, Description: `B04, B05`},
		...
		{ID: `QRY_Q26`, Description: `Q26`},
		{ID: `QRY_Q27`, Description: `Q27`},
		{ID: `QRY_Q28`, Description: `Q28`},
		{ID: `QRY_Q29`, Description: `Q29`},
		{ID: `QRY_Q30`, Description: `Q30`},
		...
		{ID: `RQI_I0I`, Description: `I01, I02, I03, I07`},
	...
	`0363`: {ID: `0363`, Name: `Assigning authority`, Row: []Row{
		{ID: `AUSDVA`, Description: `Australia - Dept. of Veterans Affairs`},
		{ID: `AUSHIC`, Description: `Australia - Health Insurance Commission`},
		{ID: `CANAB`, Description: `Canada - Alberta`},
		{ID: `CANBC`, Description: `Canada - British Columbia`},
		{ID: `CANMB`, Description: `Canada - Manitoba`},
		{ID: `CANNB`, Description: `Canada - New Brunswick`},
		{ID: `CANNF`, Description: `Canada - Newfoundland`},
		{ID: `CANNS`, Description: `Canada - Nova Scotia`},
		{ID: `CANNT`, Description: `Canada - Northwest Territories`},
		{ID: `CANNU`, Description: `Canada - Nanavut`},
		{ID: `CANON`, Description: `Canada - Ontario`},
		{ID: `CANPE`, Description: `Canada - Prince Edward Island`},
		{ID: `CANQC`, Description: `Canada - Quebec`},
		{ID: `CANSK`, Description: `Canada - Saskatchewan`},
		{ID: `CANYT`, Description: `Canada - Yukon Territories`},
		{ID: `NLVWS`, Description: `NL - Ministerie van Volksgezondheid, Welzijn en Sport`},
		{ID: `USCDC`, Description: `US Center for Disease Control`},
		{ID: `USHCFA`, Description: `US Healthcare Finance Authority`},
		{ID: `USSSA`, Description: `US Social Security Administration`}}},
	...
	`0371`: {ID: `0371`, Name: `Additive`, Row: []Row{
		{ID: `BOR`, Description: `Borate`},
	...
	`0376`: {ID: `0376`, Name: `Special handling considerations`, Row: []Row{
		{ID: `C37`, Description: `Critical maintain at 37C (e.g., cryoglobulin specimen)`},
		{ID: `CAMB`, Description: `Critical ambient temperature`},
		{ID: `CATM`, Description: `Critical do not expose to atmosphere - Do not uncap`},
		{ID: `CFRZ`, Description: `Critical Frozen`},
		{ID: `CREF`, Description: `Critical refrigerated`},
	...
	`0377`: {ID: `0377`, Name: `Other environmental factors`, Row: []Row{
		...
		{ID: `ATM`, Description: `Opened container,  atmosphere/duration unspecified`}}},
	...
	`0384`: {ID: `0384`, Name: `Substance type`, Row: []Row{
		...
		{ID: `MR`, Description: `Multiple Test Reagent (consumption cannot be tied to orders for single test)`},
		{ID: `OT`, Description: `Other`},
		{ID: `PT`, Description: `Pretreatment`},
		{ID: `PW`, Description: `Purified Water`},
		{ID: `RC`, Description: `Reagent Calibrator`},
		{ID: `SC`, Description: `Countable Solid Item (e.g., Tip, etc.)`},
	...
	`0387`: {ID: `0387`, Name: `Command response`, Row: []Row{
		{ID: `ER`, Description: `Command cannot be completed because of error condition (see response parameters)`},
	...
	`0396`: {ID: `0396`, Name: `Coding System`, Row: []Row{
		...
		{ID: `DCL`, Description: `DICOM Class Label`, Comment: `From the Message Standards Classes table of the SNOMED-DICOM-Microglossary. College of American Pathologists, Skokie, IL, 60077-1034`},
		{ID: `DCM`, Description: `DICOM modality codes`, Comment: `Dean Bidgood, MD; Duke University Medical Center, Durham NC. Digital Imaging and Communications in Medicine (DICOM). From NEMA Publications PS-3.1 - PS 3.12: The ACR-NEMA DICOM Standard. National Electrical Manufacturers Association (NEMA). Rosslyn, VA, 22209., 1992, 1993, 1995`},
		{ID: `DQL`, Description: `DICOM Query Label`, Comment: `HL7 Image Management Special Interest Group, Health Level Seven, Ann Arbor, MI.`},
		...
		{ID: `HCPCS`, Description: `HCFA Common Procedure Coding System`, Comment: `HCPCS: contains codes for medical equipment, injectable drugs, transportation services, and other services not found in CPT4.`},
		...
		{ID: `HPC`, Description: `HCFA Procedure Codes (HCPCS)`, Comment: `Health Care Financing Administration (HCFA) Common Procedure Coding System (HCPCS) including modifiers.[4]`},
		...
		{ID: `IBT`, Description: `ISBT`, Comment: `International Society of Blood Transfusion. Blood Group Terminology 1990. VOX Sanquines 1990 58(2):152-169.`},
		...
		{ID: `NPI`, Description: `National Provider Identifier`, Comment: `Health Care Finance Administration, US Dep’t. of Health and Human Services, 7500 Security Blvd., Baltimore, MD 21244.`},
		...
		{ID: `UMD`, Description: `MDNS`, Comment: `Universal Medical Device Nomenclature System. ECRI, 5200 Butler Pike, Plymouth Meeting, PA 19462 USA. Phone: 215-825-6000, Fax: 215-834-1275.`},
		...
		{ID: `UPIN`, Description: `UPIN`, Comment: `Medicare/HCFA’s universal physician identification numbers, available from Health Care Financing Administration, U.S. Dept. of Health and Human Services, Bureau of Program Operations, 6325 Security Blvd., Meadows East Bldg., Room 300, Baltimore, MD 21207`},
	...
	`0411`: {ID: `0411`, Name: `Supplemental service information values`, Row: []Row{
		{ID: `1ST`, Description: `First`},
		{ID: `2ND`, Description: `Second`},
		{ID: `3RD`, Description: `Third`},
		{ID: `4TH`, Description: `Fourth`},
		{ID: `5TH`, Description: `Fifth`},
		{ID: `A/P`, Description: `Anterior/Posterior`},
		{ID: `ANT`, Description: `Anterior`},
		{ID: `BLT`, Description: `Bilateral`},
		{ID: `DEC`, Description: `Decubitus`},
		{ID: `DST`, Description: `Distal`},
		{ID: `LAT`, Description: `Lateral`},
		{ID: `LFT`, Description: `Left`},
		{ID: `LLQ`, Description: `Left Lower Quadrant`},
		{ID: `LOW`, Description: `Lower`},
		{ID: `LUQ`, Description: `Left Upper Quadrant`},
		{ID: `MED`, Description: `Medial`},
		{ID: `OR`, Description: `Operating Room`},
		{ID: `PED`, Description: `Pediatric`},
		{ID: `POS`, Description: `Posterior`},
		{ID: `PRT`, Description: `Portable`},
		{ID: `PRX`, Description: `Proximal`},
		{ID: `REC`, Description: `Recumbent`},
		{ID: `RGH`, Description: `Right`},
		{ID: `RLQ`, Description: `Right Lower Quadrant`},
		{ID: `RUQ`, Description: `Right Upper Quadrant`},
		{ID: `UPP`, Description: `Upper`},
		{ID: `UPR`, Description: `Upright`},
		{ID: `WCT`, Description: `With Contrast`},
		{ID: `WOC`, Description: `Without Contrast`},
		{ID: `WSD`, Description: `With Sedation`}}},
	...
	`0426`: {ID: `0426`, Name: `Blood product code`, Row: []Row{
		...
		{ID: `CRYOP`, Description: `Pooled Cryopecipitate`},
	...
	`0440`: {ID: `0440`, Name: `Data types`, Row: []Row{
		...
		{ID: `CE`, Description: `Coded element`, Comment: `250`},
		{ID: `CF`, Description: `Coded element with formatted values`},
		{ID: `CK`, Description: `Composite ID with check digit`, Comment: `250`},
		{ID: `CM`, Description: `Composite`},
		{ID: `CN`, Description: `Composite ID number and name`, Comment: `250`},
		{ID: `CNE`, Description: `Coded with no exceptions`, Comment: `250`},
		{ID: `CP`, Description: `Composite price`},
		{ID: `CQ`, Description: `Composite quantity with units`},
		{ID: `CWE`, Description: `Coded with exceptions`, Comment: `250`},
		{ID: `CX`, Description: `Extended composite ID with check digit`, Comment: `250`},
		...
		{ID: `NM`, Description: `Numeric`},
		{ID: `PL`, Description: `Person location`},
		{ID: `PN`, Description: `Person name`, Comment: `48`},
		{ID: `PPN`, Description: `Performing person time stamp`, Comment: `250`},
		...
		{ID: `XAD`, Description: `Extended address`, Comment: `250`},
		{ID: `XCN`, Description: `Extended composite ID number and name`, Comment: `250`},
		{ID: `XON`, Description: `Extended composite name and ID number for organizations`, Comment: `250`},
		{ID: `XPN`, Description: `Extended person name`, Comment: `250`},
		{ID: `XTN`, Description: `Extended telecommunications number`, Comment: `250`}}},
	...
	`0449`: {ID: `0449`, Name: `Conformance statements`, Row: []Row{}},
	...
	`0455`: {ID: `0455`, Name: `Type of bill code`, Row: []Row{
		{ID: `131`, Description: `Hospital - Outpatient - Admit thru Discharge Claim`},
		{ID: `141`, Description: `Hospital - Other - Admit thru Discharge Claim`}}},
	`0456`: {ID: `0456`, Name: `Revenue code`, Row: []Row{
		{ID: `260`, Description: `IV Therapy`},
		{ID: `280`, Description: `Oncology`},
		{ID: `301`, Description: `Lab/Chemistry`},
		{ID: `991`, Description: `Cafeteria /Guest Tray`},
		{ID: `993`, Description: `Telephone/Telegraph`},
		{ID: `994`, Description: `TV/Radio`}}},
	...
	`0466`: {ID: `0466`, Name: `Ambulatory payment classification`, Row: []Row{
		{ID: `163`, Description: `Excision/biopsy`},
		{ID: `181`, Description: `Level 1 skin repair.`},
		{ID: `31`, Description: `Dental procedures`}}},
	`0467`: {ID: `0467`, Name: `Modifier edit code`, Row: []Row{
		...
		{ID: `U`, Description: `Modifer edit code unknown`}}},
	...
	`0474`: {ID: `0474`, Name: `Organization unit type`, Row: []Row{
		...
		{ID: `L`, Description: `Local market area`},
		{ID: `M`, Description: `Medical Center Area`},
