...
var TableLookup = map[string]Table{
	...
	`0396`: {ID: `0396`, Name: `Coding system`, Row: []Row{
		...
		{ID: `CDCM`, Description: `CDC Methods/Instruments Codes`, Comment: `Public Health Practice Program Office, Centers for Disease Control and Prevention, 4770 Buford Highway, Atlanta, GA, 30421. Also available via FTP: ftp.cdc .gov/pub/laboratory _info/CLIA and Gopher: gopher.cdc.gov:70/11/laboratory_info/CLIA`},
		...
		{ID: `HCPCS`, Description: `CMS (formerly HCFA) Common Procedure Coding System`, Comment: `HCPCS: contains codes for medical equipment, injectable drugs, transportation services, and other services not found in CPT4.`},
		...
		{ID: `HPC`, Description: `CMS (formerly HCFA )Procedure Codes (HCPCS)`, Comment: `Health Care Financing Administration (HCFA) Common Procedure Coding System (HCPCS) including modifiers.[7]`},
		{ID: `I10`, Description: `ICD-10`, Comment: `World Health Publications, Albany, NY.`},
		{ID: `I10P`, Description: `ICD-10 Procedure Codes`, Comment: `Procedure Coding System (ICD-10-PCS.) See http://www/hcfa.gov/stats/icd10.icd10.htm for more information.`},
		...
		{ID: `LN`, Description: `Logical Observation Identifier Names and Codes (LOINC®)`, Comment: `Regenstrief Institute, c/o LOINC, 1050 Wishard Blvd., 5th floor, Indianapolis, IN 46202. 317/630-7433. Available from the Regenstrief Institute server at http://www.Regenstrief.org/loinc/loinc.htm. Also available via HL7 file server: FTP/Gopher (www.mcis.duke.edu/standards/ termcode/loinclab and www.mcis.duke.edu/standards/termcode/loinclin) and World Wide Web ( http://www.mcis.duke.edu/standards/termcode/loincl.htm ). January 2000 version has identifiers, synonyms and cross-reference codes for reporting over 26,000 laboratory and related observations and 1,500 clinical measures.`},
		...
		{ID: `MEDR`, Description: `Medical Dictionary for Drug Regulatory Affairs (MEDDRA)`, Comment: `Dr. Louise Wood, Medicines Control Agency, Market Towers, 1 Nine Elms Lane, London SW85NQ, UK Tel: (44)0 171-273-0000 WWW: http://www.open.gov.uk/mca/mcahome.htm`},
		...
		{ID: `POS`, Description: `POS Codes`, Comment: `HCFA Place of Service Codes for Professional Claims (see http://www.hcfa.gov/medicare/poscode.htm ).`},
	...
	`0466`: {ID: `0466`, Name: `Ambulatory Payment`, Row: []Row{
	...
	`0492`: {ID: `0492`, Name: `Specimen Appropriateness`, Row: []Row{
		{ID: `??`, Description: `Inappropriate due to _`},
