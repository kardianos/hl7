...
var TableLookup = map[string]Table{
	...
	`0003`: {ID: `0003`, Name: `Event Type`, Row: []Row{
		...
		{ID: `A18`, Description: `ADT/ACK -  Merge patient information`, Comment: `Deprecated`},
		{ID: `A19`, Description: `QRY/ADR -  Patient query`, Comment: `Deprecated`},
		...
		{ID: `A30`, Description: `ADT/ACK -  Merge person information`, Comment: `Deprecated`},
		...
		{ID: `A34`, Description: `ADT/ACK -  Merge patient information - patient ID only`, Comment: `Deprecated`},
		{ID: `A35`, Description: `ADT/ACK -  Merge patient information - account number only`, Comment: `Deprecated`},
		{ID: `A36`, Description: `ADT/ACK -  Merge patient information - patient ID and account number`, Comment: `Deprecated`},
		{ID: `A37`, Description: `ADT/ACK -  Unlink patient information`},
		{ID: `A38`, Description: `ADT/ACK - Cancel pre-admit`},
		{ID: `A39`, Description: `ADT/ACK - Merge person - patient ID`, Comment: `Deprecated`},
		...
		{ID: `A46`, Description: `ADT/ACK - Change patient ID`, Comment: `Deprecated`},
		{ID: `A47`, Description: `ADT/ACK - Change patient identifier list`},
		{ID: `A48`, Description: `ADT/ACK - Change alternate patient ID`, Comment: `Deprecated`},
		...
		{ID: `I17`, Description: `Modify Collaborative Care Referral`, Comment: `Deprecated`},
		{ID: `I18`, Description: `Cancel Collaborative Care Referral`, Comment: `Deprecated`},
		...
		{ID: `M01`, Description: `MFN/MFK - Master file not otherwise specified`, Comment: `Deprecated`},
		...
		{ID: `N01`, Description: `NMQ/NMR - Application management query message`, Comment: `Deprecated`},
		{ID: `N02`, Description: `NMD/ACK - Application management data message (unsolicited)`},
		{ID: `O01`, Description: `ORM - Order message (also RDE, RDS, RGV, RAS)`, Comment: `Deprecated`},
		{ID: `O02`, Description: `ORR - Order response (also RRE, RRD, RRG, RRA)`, Comment: `Deprecated`},
		...
		{ID: `P04`, Description: `QRY/DSP - Generate bill and A/R statements`, Comment: `Deprecated`},
		...
		{ID: `P09`, Description: `SUR - Summary product experience report`, Comment: `Deprecated`},
		...
		{ID: `Q01`, Description: `QRY/DSR - Query sent for immediate response`, Comment: `Deprecated`},
		{ID: `Q02`, Description: `QRY/QCK - Query sent for deferred response`, Comment: `Deprecated`},
		{ID: `Q03`, Description: `DSR/ACK - Deferred response to a query`, Comment: `Deprecated`},
		{ID: `Q05`, Description: `UDM/ACK - Unsolicited display update message`},
		{ID: `Q06`, Description: `OSQ/OSR - Query for order status`, Comment: `Deprecated`},
		...
		{ID: `Q26`, Description: `ROR - Pharmacy/treatment order response`, Comment: `Deprecated`},
		{ID: `Q27`, Description: `RAR - Pharmacy/treatment administration information`, Comment: `Deprecated`},
		{ID: `Q28`, Description: `RDR - Pharmacy/treatment dispense information`, Comment: `Deprecated`},
		{ID: `Q29`, Description: `RER - Pharmacy/treatment encoded order information`, Comment: `Deprecated`},
		{ID: `Q30`, Description: `RGR - Pharmacy/treatment dose information`, Comment: `Deprecated`},
		...
		{ID: `R02`, Description: `QRY - Query for results of observation`, Comment: `Deprecated`},
		{ID: `R04`, Description: `ORF - Response to query; transmission of requested observation`, Comment: `Deprecated`},
		{ID: `R21`, Description: `OUL - Unsolicited laboratory observation`, Comment: `Deprecated`},
		...
		{ID: `ROR`, Description: `ROR - Pharmacy prescription order query response`, Comment: `Deprecated`},
		...
		{ID: `S25`, Description: `SQM/SQR - Schedule query message and response`, Comment: `Deprecated`},
		...
		{ID: `T12`, Description: `QRY/DOC - Document query`, Comment: `Deprecated`},
		...
		{ID: `V01`, Description: `VXQ - Query for vaccination record`, Comment: `Deprecated`},
		{ID: `V02`, Description: `VXX - Response to vaccination query returning multiple PID matches`, Comment: `Deprecated`},
		{ID: `V03`, Description: `VXR - Vaccination record response`, Comment: `Deprecated`},
		{ID: `V04`, Description: `VXU - Unsolicited vaccination record update`},
		{ID: `W01`, Description: `ORU - Waveform result, unsolicited transmission of requested information`, Comment: `Deprecated`},
		{ID: `W02`, Description: `QRF - Waveform result, response to query`, Comment: `Deprecated`}}},
	...
	`0301`: {ID: `0301`, Name: `Universal ID Type`, Row: []Row{
		...
		{ID: `CLIP`, Description: `Clinical laboratory Improvement Program. Allows for the ability to designate organization identifier as a "CLIP" assigned number (for labs).Â Used by US Department of Defense.`},
	...
	`0396`: {ID: `0396`, Name: `Coding System`, Row: []Row{
		...
		{ID: `LN`, Description: `Logical Observation Identifier Names and Codes (LOINCÂ®)`},
	...
	`0507`: {ID: `0507`, Name: `Observation Result Handling`, Row: []Row{
		{ID: `A`, Description: `Alert provider when abnormal`},
		{ID: `BCC`, Description: `Blind Copy`},
		{ID: `CC`, Description: `Copies Requested`},
